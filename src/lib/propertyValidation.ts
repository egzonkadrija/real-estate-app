...
export const updatePropertySchema = z.object({
  ...
  title_mk: basePropertySchemaShape.title_mk.optional(),
  title_tr: basePropertySchemaShape.title_tr.optional(),
